...
/**
* Load collection data from a binary file
* @author lkoeble 21487
*/
public class LoadBinary implements ICLIEndpoint {
    @Override
    public void call(String[] params, ProcessOutputBuffer _out, CLI _cli) {
        ...
        if (params[0].equalsIgnoreCase("default")) params[0] = SaveBinary.DEFAULT_BINARY_FILE;
