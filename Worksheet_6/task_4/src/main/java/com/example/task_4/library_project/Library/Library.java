...
import com.example.task_4.library_project.Library.io.*;
...
public class Library {
    ...
    public static boolean SORT_REVERSED = false;
    ...
    {
        collection.sort(Library.SORT_REVERSED);
        SORT_REVERSED = !Library.SORT_REVERSED;
    }
